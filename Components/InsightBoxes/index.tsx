...
const Box: React.FC<BoxProps> = ({ item1, item2, item3, item4, type }) => {
	return (
		<div>
			{type == "big" ? (
				<div style={{width:'200px'}} className="flex flex-col items-center  justify-center h-[200px] bg-white border-[3px] mr-2 border-solid border-eccblue rounded-[14px]">
				...
				<div style={{width:'175px'}} className="flex flex-col items-center  justify-center h-[160px] bg-white border-[1px] mr-2 border-solid border-eccblue rounded-[14px]">
