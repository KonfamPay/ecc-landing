			...
			<div className="flex px-[0px] lg:px-[100px] justify-between items-center py-[20px] lg:pt-[235px]">
				<div className="bg-[#F1F7FE] px-[] lg:px-[32px] lg:rounded-[20px] pt-[74px] pb-[36px] lg:py-[82px] w-full relative">
                    ...
                    <div className="rounded-[20px] border-[#0B63C5] border-[3px] border-dashed p-[8px] lg:p-[28px] lg:w-[434px] absolute top-[-70px] left-[50%] translate-x-[-50%] lg:left-[unset] lg:translate-x-[unset] lg:right-[-50px] flex justify-center">
                        <img src="assets/Images/awareness.png" alt="awareness" className="w-[110px] lg:w-[378px]" />
                    </div>
                    <img src="assets/Images/blackDots.png" alt="black-dot" className="w-[30px] lg:w-[unset] absolute bottom-[-15px] lg:bottom-[unset] left-[24px] lg:top-[-40px] lg:left-[48px]" />
                    <img src="assets/Images/blueDots.png" alt="blue-dot" className="w-[30px] lg:w-[unset] absolute top-[-15px] lg:top-[unset] right-[15px] lg:bottom-[-28px] lg:right-[95px]" />
                    <img src="assets/Images/blackPolygon.png" alt="black-polygon" className="absolute w-[14.43px] lg:w-[unset] right-[138px] lg:right-[unset] bottom-[1px] lg:bottom-[-45px] lg:left-[48px]" />
                    <img src="assets/Images/smallBlackPolygon.png" alt="black-polygon" className="absolute w-[14.43px] lg:w-[unset] top-[12px] lg:top-[unset] right-[86px] bottom-[-65px] lg:right-[280px]" />
                    <img src="assets/Images/bluePolygon.png" alt="Blue-polygon" className="absolute left-[81px] lg:left-[unset] top-[-35px] lg:top-[unset] w-[14.43px] lg:w-[unset] lg:bottom-[29px] lg:right-[337px]" />
				</div>
			</div>
		</>
	);
...
export default TiredOfGettingScammed;
